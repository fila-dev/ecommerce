...
const Sidebar = () => {
  ...
  const menus = [
    ...
    { name: "users", link: "/admin/users", icon: HiUserGroup },
    { name: "providers", link: "/admin/providers", icon: AiOutlineUser },
    { name: "sales", link: "/admin/sales", icon: LiaFunnelDollarSolid },
    { name: "Add categories", link: "/admin/categories", icon: TbReportAnalytics },
    { name: "messages", link: "/admin/sms", icon: FiMessageSquare },
